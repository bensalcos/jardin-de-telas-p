...
export const regiones = [
  {
    ...
    romanNumber: "XV",
    number: "15",
    communes: [{ name: "Arica" }, { name: "Camarones" }, { name: "General Lagos" }, { name: "Putre" }],
  },
  {
    name: "Tarapacá",
    romanNumber: "I",
    number: "1",
    communes: [{ name: "Alto Hospicio" }, { name: "Camiña" }, { name: "Colchane" }, { name: "Huara" }, { name: "Iquique" }, { name: "Pica" }, { name: "Pozo Almonte" }],
  },
  {
    name: "Antofagasta",
    romanNumber: "II",
